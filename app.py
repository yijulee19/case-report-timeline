...
yellow_anno = annotation_style("#D6B656", "#FFF2CC")
blue_anno = annotation_style("#6C8EBF", "#DAE8FC")
blue_anno_no_arrow = annotation_style("#6C8EBF", "#DAE8FC")
gray_anno = annotation_style("#A6A6A6", "#F2F2F2", font={"size": 11, "color": "black"})
...
with tab2:
    ...
    fig2.add_annotation(x="2026-07-14", y=0.5, text="冷熱交替浴", showarrow=False, font={"size": 12, "color": "#103667"}, row=2, col=1)
